...
function ComplaintDetailModal({ complaint, onClose }) {
    ...
    const handleSave = () => {
        updateComplaintStatus(complaint.id, status, adminNotes, citizenMsg, adminUser?.name || 'Admin');
        setSaved(true);
                    ...
                    <div style={{ marginBottom: 20 }}>
                        ...
                        <div className="grid-2 grid" style={{ marginBottom: 14 }}>
                            ...
                            <div className="form-group" style={{ margin: 0 }}>
                                ...
                                <input className="form-control" defaultValue={complaint.assignedTo} placeholder="Assign technician name" disabled={!canEditComplaint}/>
                            </div>
                        </div>
    ...
    return (<div className="space-y-4">
            ...
            <div className="card">
                <table className="data-table">
                    ...
                    <tbody>
                        {paginated.map(c => (<tr key={c.id} onClick={() => { setSelected(c); if (!c.checked)
            markAsChecked('complaint', c.id); }} style={{ cursor: 'pointer' }}>
