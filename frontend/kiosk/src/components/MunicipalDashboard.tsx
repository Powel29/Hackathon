            ...
            <div key={index} className="bg-gray-50 border border-gray-200 rounded-lg p-3">
              <div className="flex items-center justify-between mb-2">
                ...
                <span className={`text-xs font-semibold px-2 py-0.5 rounded-full ${
                  facility.color === 'green' ? 'bg-green-100 text-green-700' :
            ...
            <div key={index} className="flex items-center justify-between p-3 bg-gray-50 rounded-lg hover:bg-gray-100 cursor-pointer transition-colors"
              ...
              <div className="flex items-center gap-3">
                <div className={`w-8 h-8 ${
                  complaint.color === 'green' ? 'bg-green-100' :
                  complaint.color === 'blue' ? 'bg-blue-100' :
                  'bg-yellow-100'
                } rounded-lg flex items-center justify-center`}>
                  <FileText className={`w-4 h-4 ${
                    complaint.color === 'green' ? 'text-green-600' :
              ...
              <span className={`text-xs font-semibold px-2 py-1 rounded-full ${
                complaint.color === 'green' ? 'bg-green-100 text-green-700' :
