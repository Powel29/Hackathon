...
export function DepartmentVerification() {
  ...
  const { selectedService, setUser, user } = useStore();
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <input
                  ...
                  className={`w-full px-4 py-3 border-2 rounded-lg text-base focus:outline-none focus:ring-2 focus:ring-[#0066CC] focus:border-transparent transition-all ${
