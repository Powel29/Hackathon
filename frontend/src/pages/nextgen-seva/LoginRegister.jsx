  ...
  const handleOtpVerify = async () => {
    ...
    try {
      ...
      if (verifyResponse.success) {
        ...
        // Token storage is handled by authService via tokenStrategy
                ...
                <div className="flex gap-2 sm:gap-3 justify-center mb-6">
                  {otp.map((digit, index) => (
                    <input
                      ...
                      className="w-10 h-12 sm:w-12 sm:h-14 text-center text-lg sm:text-xl font-bold border-2 border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#0066CC] focus:border-transparent"
                    />
                  ))}
                </div>
