...
import { SuccessScreen } from '../../components/nextgen-seva/SuccessScreen';
...
export function NewConnection() {
  ...
  const handlePrintApplication = () => {
    ...
    if (formData.signatureType === 'digital' && formData.signature) {
      ...
      reader.onload = (e) => {
        if (e.target?.result) {
          generatePrintDocument(e.target.result);
        }
      };
  ...
  const generatePrintDocument = (signatureData) => {
    ...
    const html = `
      ...
      <html>
        ...
        <body>
          ...
          <div class="watermark">NextGen Seva</div>
          ...
          <div class="footer">
            <p><strong>NextGen Seva - Unified Services Portal</strong> | Government of India</p>
            <p style="font-size: 6pt;">Form Ref: NextGen Seva/${escapeHTML(serviceName.toUpperCase())}/NC/2026 | This is a computer-generated form</p>
          </div>
          </div>
          </div>
        </body>
            ...
            {[...Array(totalSteps)].map((_, index) => (
              <div key={index} className="flex items-center flex-1">
                <div className="flex flex-col items-center flex-1">
                  <div className={`w-10 h-10 rounded-full flex items-center justify-center text-sm font-bold ${index + 1 < currentStep
                  ...
                  <p className={`text-xs mt-2 text-center ${index + 1 === currentStep ? 'font-semibold text-[#0066CC]' : 'text-gray-600'
                    }`}>
                    {stepTitles[index]}
                  </p>
                </div>
                {index < totalSteps - 1 && (
                  <div className={`h-0.5 flex-1 mx-2 rounded ${index + 1 < currentStep ? 'bg-[#28A745]' : 'bg-gray-200'
                    }`}></div>
                )}
              </div>
            ))}
            ...
            <div className="space-y-4">
              <div>
                ...
                <input
                  ...
                  className={`w-full px-4 py-2 border rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-[#0066CC] focus:border-transparent ${formErrors.fullName ? 'border-red-500' : 'border-gray-300'
                    }`}
                />
              ...
              <div>
                ...
                <input
                  ...
                  maxLength={10}
                  className={`w-full px-4 py-2 border rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-[#0066CC] focus:border-transparent ${formErrors.mobileNumber ? 'border-red-500' : 'border-gray-300'
                    }`}
                />
              ...
              <div>
                ...
                <input
                  ...
                  className={`w-full px-4 py-2 border rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-[#0066CC] focus:border-transparent ${formErrors.emailAddress ? 'border-red-500' : 'border-gray-300'
                    }`}
                />
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <textarea
                  ...
                  className={`w-full h-24 px-4 py-2 border rounded-lg text-sm resize-none focus:outline-none focus:ring-2 focus:ring-[#0066CC] focus:border-transparent ${formErrors.address ? 'border-red-500' : 'border-gray-300'
                    }`}
                />
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <select
                    ...
                    className={`w-full px-4 py-2 border rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-[#0066CC] focus:border-transparent ${formErrors.state ? 'border-red-500' : 'border-gray-300'
                      }`}
                  >
                ...
                <div>
                  ...
                  <select
                    ...
                    className={`w-full px-4 py-2 border rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-[#0066CC] focus:border-transparent disabled:bg-gray-100 disabled:cursor-not-allowed ${formErrors.city ? 'border-red-500' : 'border-gray-300'
                      }`}
                  >
                    <option value="">
              ...
              <div>
                ...
                <input
                  ...
                  className={`w-full px-4 py-2 border rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-[#0066CC] focus:border-transparent ${formErrors.pincode ? 'border-red-500' : 'border-gray-300'
                    }`}
                />
                ...
                <div className="grid grid-cols-3 gap-3">
                  {(selectedService === 'electricity'
                    ...
                    <button
                      ...
                      className={`p-4 border-2 rounded-lg text-sm font-semibold transition-all ${formData.connectionType === type
              ...
              {selectedService === 'electricity' && (
                <>
                  <div>
                    ...
                    <div className="grid grid-cols-3 gap-3">
                      {['domestic', 'commercial', 'temporary'].map((type) => (
                        <button
                          key={type}
                          onClick={() => handleInputChange('purposeOfSupply', type)}
                          className={`p-4 border-2 rounded-lg text-sm font-semibold transition-all ${formData.purposeOfSupply === type
                            ? 'border-[#0066CC] bg-blue-50 text-[#0066CC]'
                            : 'border-gray-200 bg-white text-gray-700 hover:border-gray-300'
                            }`}
                        >
                  ...
                  <div>
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      {['single', 'three'].map((type) => (
                        <button
                          key={type}
                          onClick={() => handleInputChange('phaseRequired', type)}
                          className={`p-4 border-2 rounded-lg text-sm font-semibold transition-all ${formData.phaseRequired === type
                            ? 'border-[#0066CC] bg-blue-50 text-[#0066CC]'
                            : 'border-gray-200 bg-white text-gray-700 hover:border-gray-300'
                            }`}
                        >
                  ...
                  <div>
                    ...
                    <input
                      ...
                      placeholder="e.g., 5.5"
                      className={`w-full px-4 py-2 border rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-[#0066CC] focus:border-transparent ${formErrors.connectedLoad ? 'border-red-500' : 'border-gray-300'
                        }`}
                    />
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      {['indoor', 'outdoor'].map((type) => (
                        <button
                          ...
                          className={`p-4 border-2 rounded-lg text-sm font-semibold transition-all ${formData.meterLocation === type
                            ? 'border-[#0066CC] bg-blue-50 text-[#0066CC]'
                            : 'border-gray-200 bg-white text-gray-700 hover:border-gray-300'
                            }`}
                        >
                ...
                <>
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      {['PNG', 'LPG'].map((type) => (
                        <button
                          ...
                          className={`p-4 border-2 rounded-lg text-sm font-semibold transition-all ${formData.gasType === type
                            ? 'border-[#0066CC] bg-blue-50 text-[#0066CC]'
                            : 'border-gray-200 bg-white text-gray-700 hover:border-gray-300'
                            }`}
                        >
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      {['domestic', 'commercial'].map((type) => (
                        <button
                          ...
                          className={`p-4 border-2 rounded-lg text-sm font-semibold transition-all ${formData.kitchenType === type
                            ? 'border-[#0066CC] bg-blue-50 text-[#0066CC]'
                            : 'border-gray-200 bg-white text-gray-700 hover:border-gray-300'
                            }`}
                        >
                  ...
                  <div>
                    ...
                    <input
                      ...
                      placeholder="e.g., 2"
                      className={`w-full px-4 py-2 border rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-[#0066CC] focus:border-transparent ${formErrors.numberOfBurners ? 'border-red-500' : 'border-gray-300'
                        }`}
                    />
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      {['yes', 'no'].map((type) => (
                        <button
                          ...
                          className={`p-4 border-2 rounded-lg text-sm font-semibold transition-all ${formData.pipelineAvailability === type
                            ? 'border-[#0066CC] bg-blue-50 text-[#0066CC]'
                            : 'border-gray-200 bg-white text-gray-700 hover:border-gray-300'
                            }`}
                        >
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      {['yes', 'no'].map((type) => (
                        <button
                          ...
                          className={`p-4 border-2 rounded-lg text-sm font-semibold transition-all ${formData.existingGasConnection === type
                            ? 'border-[#0066CC] bg-blue-50 text-[#0066CC]'
                            : 'border-gray-200 bg-white text-gray-700 hover:border-gray-300'
                            }`}
                        >
              ...
              {selectedService === 'water' && (
                <>
                  <div>
                    ...
                    <div className="grid grid-cols-3 gap-3">
                      {['domestic', 'commercial', 'construction'].map((type) => (
                        <button
                          key={type}
                          onClick={() => handleInputChange('waterPurpose', type)}
                          className={`p-4 border-2 rounded-lg text-sm font-semibold transition-all ${formData.waterPurpose === type
                            ? 'border-[#0066CC] bg-blue-50 text-[#0066CC]'
                            : 'border-gray-200 bg-white text-gray-700 hover:border-gray-300'
                            }`}
                        >
                  ...
                  <div>
                    ...
                    <input
                      ...
                      placeholder="e.g., 500"
                      className={`w-full px-4 py-2 border rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-[#0066CC] focus:border-transparent ${formErrors.waterCapacity ? 'border-red-500' : 'border-gray-300'
                        }`}
                    />
                  ...
                  <div>
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      {['municipal', 'borewell'].map((type) => (
                        <button
                          key={type}
                          onClick={() => handleInputChange('sourceType', type)}
                          className={`p-4 border-2 rounded-lg text-sm font-semibold transition-all ${formData.sourceType === type
                            ? 'border-[#0066CC] bg-blue-50 text-[#0066CC]'
                            : 'border-gray-200 bg-white text-gray-700 hover:border-gray-300'
                            }`}
                        >
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      {['yes', 'no'].map((type) => (
                        <button
                          ...
                          className={`p-4 border-2 rounded-lg text-sm font-semibold transition-all ${formData.existingWaterConnection === type
                            ? 'border-[#0066CC] bg-blue-50 text-[#0066CC]'
                            : 'border-gray-200 bg-white text-gray-700 hover:border-gray-300'
                            }`}
                        >
              ...
              {selectedService === 'municipal' && (
                <>
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      {[
                        ...
                        <button
                          ...
                          className={`p-4 border-2 rounded-lg text-sm font-semibold transition-all ${formData.municipalServiceType === type.value
                            ? 'border-[#0066CC] bg-blue-50 text-[#0066CC]'
                            : 'border-gray-200 bg-white text-gray-700 hover:border-gray-300'
                            }`}
                        >
                  ...
                  <div>
                    ...
                    <div className="grid grid-cols-3 gap-3">
                      {['apartment', 'independent', 'shop'].map((type) => (
                        <button
                          key={type}
                          onClick={() => handleInputChange('propertyType', type)}
                          className={`p-4 border-2 rounded-lg text-sm font-semibold transition-all ${formData.propertyType === type
                            ? 'border-[#0066CC] bg-blue-50 text-[#0066CC]'
                            : 'border-gray-200 bg-white text-gray-700 hover:border-gray-300'
                            }`}
                        >
                  ...
                  <div>
                    ...
                    <input
                      ...
                      placeholder="e.g., 2"
                      className={`w-full px-4 py-2 border rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-[#0066CC] focus:border-transparent ${formErrors.numberOfFloors ? 'border-red-500' : 'border-gray-300'
                        }`}
                    />
