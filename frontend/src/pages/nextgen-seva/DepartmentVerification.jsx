  ...
  const handleVerify = async () => {
    ...
    try {
      ...
      if (!isOnline) {
        ...
        toast.info('Offline Mode: Verification will sync later');
        navigate('/nextgen-seva/dashboard');
        return;
      }
      const response = await departmentService.verifyAccount(selectedService, departmentId.trim());
      if (response.success) {
        setUser({
          ...(user || {}),
        ...
        <div className="w-full max-w-2xl">
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-8">
            ...
            <div className="space-y-6">
              ...
              {/* Account not found – request admin approval */}
                  ...
                  <div className="flex items-start gap-3 mb-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-amber-700 mt-1">
                        If you believe your consumer number is correct, you can request the admin to verify and create your account. Enter the consumer number above and click the button below.
                      </p>
                    </div>
                  </div>
                  <TouchButton
                ...
                <div className="bg-green-50 border border-green-300 rounded-xl p-5 flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-green-700 mt-1">
                      Your request for <strong>{departmentId}</strong> has been sent to the admin. Once approved, you can log in and access your department account.
                    </p>
                  </div>
                </div>
              )}
