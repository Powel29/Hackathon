                    ...
                    <div className="max-w-7xl mx-auto px-4 py-3 flex items-center justify-between">
                        ...
                        <div className="flex items-center gap-4">
                            ...
                            >
                                ...
                                <span className="text-xs text-gray-500 easy-mode-hide">{isOnline ? 'Online' : 'Offline'}</span>
                            </div>

                            {/* Clock */}
                            <div className="flex items-center gap-1 text-gray-500 easy-mode-hide">
                            ...
                            {showLanguageSwitch && (
                                <div className="flex items-center gap-1.5">
                                    ...
                                    <select
                                        ...
                                        className="px-3 py-2 bg-white border border-gray-300 text-gray-700 rounded-lg text-sm font-medium focus:outline-none focus:ring-2 focus:ring-[#0066CC] min-h-[40px]"
                    ...
                    <div className="max-w-7xl mx-auto px-4 flex items-center justify-between">
                        ...
                        <div className="flex items-center gap-2">
                            ...
                            >
                                ...
                                <span className="easy-mode-hide">Home</span>
                            </button>
                            <button
                            ...
                            >
                                ...
                                <span className="easy-mode-hide">Help</span>
                            </button>
                        </div>
