...
export default function BillingChatbot() {
  ...
  const suggestions = [
    "Show all my invoices", "Download invoice INV-002",
    "Check transaction TXN-7930", "What payment methods do I have?",
    "Upload proof for INV-003", "What's my account balance?",
    "Retry payment for INV-002", "My payment keeps failing",
  ];
      ...
      <div style={{ width: "100%", height: "100vh", background: "#161b27", border: "none", display: "flex", flexDirection: "column", overflow: "hidden" }}>
        ...
        <div style={{ padding: "18px 24px", borderBottom: "1px solid #1e2635", background: "#0e1521", display: "flex", alignItems: "center", gap: 14 }}>
          ...
          <div>
            ...
            <div style={{ color: "#4a90d9", fontSize: 12, display: "flex", alignItems: "center", gap: 5 }}>
              ...
              LangChain · Groq Llama 3.3 70B · 7 Tools · OCR Enabled
            </div>
          </div>
          ...
          {messages.length === 0 && (
            <div style={{ flex: 1, display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", gap: 24 }}>
              <div style={{ textAlign: "center" }}>
                ...
                <div style={{ color: "#4a5568", fontSize: 13, marginBottom: 4 }}>Powered by LangChain + Groq with 7 real tools</div>
                <div style={{ color: "#6b46c1", fontSize: 12 }}>📎 Upload invoices or receipts — OCR reads them automatically</div>
              </div>
        ...
        <div style={{ padding: "14px 20px", borderTop: "1px solid #1e2635", background: "#0e1521" }}>
          ...
          <div style={{ textAlign: "center", marginTop: 8, color: "#2d3748", fontSize: 11 }}>
            Secured · LangChain + Groq (Free) · OCR by Tesseract.js · Tool calls visible above each response
          </div>
        </div>
      </div>
    </div>
